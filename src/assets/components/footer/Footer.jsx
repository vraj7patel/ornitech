        ...
        <div className="footer-top-grid">
          ...
          >
            ...
            <div className="social-pill-bar">
              <a
                href="https://github.com/Ornitech-26"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/ornitech_solution/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/company/ornitech-solution/posts/?feedView=all"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="social-pill"
